...
(autothemer-deftheme
 ...
 ((((class color) (min-colors #xFFFFFF))        ; col 1 GUI/24bit
  ...
  (diff-hl-change                                (:foreground sakuraPink :background sakuraPink))
  (diff-hl-delete                                (:foreground roninYellow :background roninYellow))
  (diff-hl-insert                                (:foreground springGreen :background springGreen))
