...
(use-package doom-themes
    ...
    (custom-theme-set-faces
     'doom-ir-black
      '(default ((t (:background "#120c0a" :foreground "white"))))
      '(hl-line ((t (:background "#1f1715"))))
      '(doom-modeline-bar-inactive ((t (:background "#1f1715"))))
      '(font-lock-comment-face ((t (:foreground "#cf9f8f"))))
      '(font-lock-doc-face ((t (:foreground "#96cbfe"))))
...
(use-package drag-stuff
  :ensure t
  :config   (global-set-key (kbd "M-p") 'drag-stuff-up)
